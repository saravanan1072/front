...
const Footer = () => {
    return (
      <div style={{color:"white",marginTop:"80px"}}>
        <div id="Footer-main-container-body">
          <div>
            <img
          ...
          <div>
            ...
            <div className="hover-effect-border">CodeStudio</div>
          ...
          <div>
            <div className="title-footer">FOLLOW US ON</div>
            <div>
              ...
              <img
                ...
                alt="404 Error"
              /></a>
              <a href="https://t.me/+aOwmkTIdH8wyMjQ1?utm_source=telegram-campus&utm_medium=website&utm_campaign=guidedpath_9jan2028">
              <img
            ...
            <div className="footer-phone-email">
              <img
                ...
                alt="email id"
              />
              <div>contact@codingninjas.com</div>
            </div>
          </div>
        </div>
        ...
        <div className="payment-neetchae-least-end">
          <div>
              <span className="just-payment-top-position">We accept payments using:</span>
              <img src="https://files.codingninjas.in/visa-5604.png" alt="404 Error"/>
              <img src="https://files.codingninjas.in/paypal-5603.png" alt="404 Error"/>
              <img src="https://files.codingninjas.in/upi-5602.png" alt="404 Error"/>
              <img src="https://files.codingninjas.in/no-cost-emi-5601.png" alt="404 Error"/>
          </div>
          <div>
              <img src="https://files.codingninjas.in/secure-5600.png" alt="404 Error"/>
              <img src="https://files.codingninjas.in/encryp-5599.png" alt="404 Error"/>
              <img src="https://files.codingninjas.in/razorpay-5598.png" alt="404 Error"/>
          </div>
        </div>
      </div>
    );
